...
public class MessageService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        if (!MeegosPreferences.getUsername(this).isEmpty()) {
            final String timestamp = DateUtil.getCalendarAsString(Calendar.getInstance(), Constants.CALENDAR_FORMAT_PATTERN);
...
//                        Actualizamos el Timestamp para la proxima busqueda
                         MeegosPreferences.setTimestamp(getApplicationContext(), timestamp);
